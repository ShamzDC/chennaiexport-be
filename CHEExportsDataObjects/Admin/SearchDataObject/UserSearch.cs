...
namespace CHEExportsDataObjects
{
    [Serializable]
    [DataContract]
    public partial class UserSearch : SearchBase
    {
        [DataMember]
    ...
    [Serializable]
    [DataContract]
    public partial class UserSearchResultset : SearchResultSet
    {
        [DataMember]
        public long user_id { get; set; }
        ...
        public string department_description_column_name = "DEPARTMENT_DESCRIPTION";
        public string branch_description_column_name = "BRANCH_DESCRIPTION";
        public string designation_description_column_name = "DESIGNATION_DESCRIPTION";
        public string status_description_column_name = "STATUS_DESCRIPTION";
        public string gender_description_column_name = "GENDER_DESCRIPTION";
        public string team_description_column_name = "TEAM_DESCRIPTION";
    }
}
