...
namespace CHEExportsDataObjects
{
    [Serializable]
    [DataContract]
    public partial class ProductSearch : SearchBase
    {
    ...
    [Serializable]
    [DataContract]
    public partial class ProductSearchResultset : SearchResultSet
    {
        [DataMember]
        ...
        [DataMember]
        public string hsn_sac_number { get; set; }
        ...
        public string hsn_sac_number_column_name = "HSN_SAC_NUMBER";
