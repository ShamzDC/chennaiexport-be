...
namespace CHEExportsDataObjects
{
    [Serializable]
    [DataContract]
    public partial class ConsigneeSearch : SearchBase
    {
    ...
    [Serializable]
    [DataContract]
    public partial class ConsigneeSearchResultset : SearchResultSet
    {
        [DataMember]
        public long consignee_id { get; set; }
        ...
        public string consignee_id_column_name_is_primary = "CONSIGNEE_ID";
        public string consignee_name_column_name = "CONSIGNEE_NAME";
        public string consignee_ref_no_column_name = "CONSIGNEE_REF_NO";
