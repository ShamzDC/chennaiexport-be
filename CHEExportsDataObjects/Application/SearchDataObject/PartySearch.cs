...
namespace CHEExportsDataObjects
{
    ...
    [Serializable]
    [DataContract]
    public partial class PartySearch : SearchBase
    {
    ...
    [Serializable]
    [DataContract]
    public partial class PartySearchResultset : SearchResultSet
    {
        [DataMember]
        public long party_id { get; set; }
        ...
        public string party_id_column_name_is_primary = "PARTY_ID";
        public string party_name_column_name = "PARTY_NAME";
        public string party_ref_no_column_name = "PARTY_REF_NO";
