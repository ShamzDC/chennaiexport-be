...
namespace CHEExportsDataObjects
{
    [Serializable]
    [DataContract]
    public partial class BuyerSearch : SearchBase
    {
    ...
    [Serializable]
    [DataContract]
    public partial class BuyerSearchResultset : SearchResultSet
    {
        [DataMember]
        public long buyer_id { get; set; }
        ...
        public string buyer_id_column_name_is_primary = "BUYER_ID";
        public string buyer_name_column_name = "BUYER_NAME";
        public string buyer_ref_no_column_name = "BUYER_REF_NO";
