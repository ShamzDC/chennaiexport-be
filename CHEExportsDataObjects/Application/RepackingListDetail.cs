...
namespace CHEExportsDataObjects
{
    [Serializable]
    [DataContract]
    public partial class RepackingListDetail : DataObjectBase
    {
        public RepackingListDetail()
        {
            TABLE_NAME = "APP_REPACKING_LIST_DETAIL";
        ...
        [DataMember]
        public long repacking_list_detail_id { get; set; }
        ...
        [DataMember]
        public string is_verifird { get; set; }
        [DataMember]
        public Product iProduct { get; set; }



        public string repacking_list_detail_id_column_name_is_primary = "REPACKING_LIST_DETAIL_ID";
        ...
        public string is_verifird_column_name = "IS_VERIFIRD";
    }
}
